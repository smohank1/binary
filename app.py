...
model_loaded = load_catdog_model()
if not model_loaded:
    print("WARNING: Model failed to load. Application will start but predictions will fail.")
    print("Make sure 'catdogmodel0603.h5' is in the root directory.")

if __name__ == '__main__':
    # This block only runs in development (python app.py)
    if model_loaded:
